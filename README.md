...
The parity smoke builds this repository with `scripts/build.sh`, reports a
`--list-rules` comparison signal, creates tiny temporary trailing-whitespace,
...
It includes report-only coverage for `--list-rules`, explicit `--config`, CLI
