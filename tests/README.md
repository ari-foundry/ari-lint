...
adapter, but the lightweight checks do not execute main-entry tests or
...
for source-file lint results, source-file JSON stdout output, no process exit
...
for non-output paths, source-file JSON stdout output, no process exit calls,
