...
printf '%s\n' "known differences:"
printf '%s\n' "- standalone Ari process capture concatenates stderr then stdout; original tools/lint observes shared-pipe interleaving."
...
printf '%s\n' "aligned native runtime contract: files JSON envelope, clean-file accounting, human stdout shape, and diagnostic exit 1."
printf '%s\n' "aligned compiler runtime signals: per-source exitCode, missing/source/compiler diagnostics, and include forwarding."
printf '%s\n' ""
