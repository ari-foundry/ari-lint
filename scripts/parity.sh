...
printf '%s\n' "- current clean, disabled-rule, and mixed clean/dirty JSON outputs omit clean file path entries; original tools/lint keeps per-file entries with empty diagnostics."
