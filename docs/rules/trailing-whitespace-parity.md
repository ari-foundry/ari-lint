...
This document defines how `lint/trailing-whitespace` behavior is compared
...
policy now match the reference; source-controlled strict comparison is gated
for the initial native case, while broader comparison remains future work.
